...
type HostManager interface {
	...
	RunPitbullForPasslist(instance HostInstance, walletString, passlistUrl string, skipCount int64) error

	// RunPitbullForTokenlist - runs Pitbull process on given host instance with provided tokenlist.
	RunPitbullForTokenlist(instance HostInstance, walletString, tokenlist string, skipCount int64) error
